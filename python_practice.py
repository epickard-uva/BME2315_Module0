...
XXX 
    ...
    create fibonacci sequence list with first two numbers 0 and 1
    create loop to generate fibonacci numbers up until N numbers are created
        append each new fibonacci number to the list
    sum the list of fibonacci numbers
    output the sum  
XXX
"""
